        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @if(isset($dataTypeContent->details))
                    ...
                    @if(isset($dataTypeContent->deliver_address))
                        <div class="panel-heading" style="border-bottom:0;">
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            @php
                                $address = $dataTypeContent->deliver_address
                            @endphp
                            <p> {{ $address->other_address_details.", ".$address->county_district.", ".$address->province_city }} </p>
                        </div>
                    @endif
                    <!-- form start -->
